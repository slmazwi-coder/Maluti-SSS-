                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <Field label="Name & Address of School Admitted To" className="sm:col-span-2">
                          <input className={inp} value={learner.schoolNameAndAddress} onChange={e => patchL('schoolNameAndAddress', e.target.value)} placeholder="Maluti SSS, Igoga Location, Matatiele" />
                        </Field>
